...
*/
	...
	private void startNewBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startNewBtnActionPerformed
		...
		if (servname!=null)
		{
			try
			{
				...
				//--------------------------------------------------
				new TangoServer(servname, false).startupLevel(this, host.getName(), p);
			}
			catch (DevFailed e)
			{
   ...
   private synchronized Vector[] buildVectorOfStartupLevel()
   {
	...
	private void createStartupLevelPanels()
	{
		...
		notifydBtn.setVisible(host.use_events);
  ...
  //======================================================
	...
	void checkUpdatePanel(boolean forced)
	{
		if (forced)
		{
			//System.out.println( btn.length + " btn   " +
			//				host.nbServers() + " servers");
  ...
  // End of variables declaration//GEN-END:variables
	...
	class  ServerThread extends Thread
	{
		 ...
		 */
		//===============================================================
		private synchronized void updateData(boolean b)
		{
			update_data = b;
			notify();
		}
		...
		private synchronized void updateParent()
		{
			...
			if (notifydBtn.isVisible())
			{
				...
				{
					//	If not available set button not visible
					notifydBtn.setVisible(false);
					pack();
				}
			}
		}
