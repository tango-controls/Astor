...
public class ServerPopupMenu extends JPopupMenu implements AstorDefs {
	...
	static private final int	POOL_THREAD_MAN =  5;
	static private final int	CONFIGURE       =  6;
	static private final int	DB_ATTRIBUTES   =  7;
	static private final int	SERVER_INFO     =  8;
	static private final int	CLASS_INFO      =  9;
	static private final int	DEPENDENCIES    = 10;
	static private final int	TEST_DEVICE     = 11;
	static private final int	CHECK_STATES    = 12;
	static private final int	BLACK_BOX       = 13;
	static private final int	STARTER_LOGS    = 14;
	static private final int	STD_ERROR       = 15;
	...
	private void levelCmdActionPerformed(ActionEvent evt)
	{
		...
		case CHANGE_LEVEL:
			...
			break;
		case SERVER_LEVELS:
			tree.changeServerLevels(tree.getLevelRow());
			break;
		case EXPAND:
