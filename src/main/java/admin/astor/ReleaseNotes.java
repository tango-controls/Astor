...
public interface ReleaseNotes {
	String htmlString = 
		...
		"generated: 21-04-2020  08:03</center>\n" + 
		"<li><b>Astor-7.3.1 - 21/04/20:</b><br>" + 
		"&nbsp; &nbsp; &nbsp; Remove all notifd references<br>" + 
		...
		"&nbsp; &nbsp; &nbsp; Remove warning trace<br>" + 
		"<li><b>Astor-7.2.5 -  02/04/19:</b><br>" + 
		"&nbsp; &nbsp; &nbsp; Minor changes<br>" + 
		"<li><b>Astor-7.2.4 -  17/01/19:</b><br>" + 
		"&nbsp; &nbsp; &nbsp; Fix a small problem in server startup level<br>" + 
		...
		"&nbsp; &nbsp; &nbsp; Replace ReleaseNote file by CHANGELOG.md<br>" + 
		"<li><b>Astor-7.2.1 -  09/01/18:</b><br>" + 
		...
		"&nbsp; &nbsp; &nbsp; Manage the Starter check for several instances for a server.<br>" + 
