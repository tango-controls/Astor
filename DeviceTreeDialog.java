...
public class DeviceTreeDialog extends javax.swing.JDialog {
	...
	private void ctrlServersButtonActionPerformed (java.awt.event.ActionEvent evt) {
		...
		if (tableDialog==null)
		{
			try
			{
				Vector	v = tree.getNotCtrlServers();
				Vector	v0 = (Vector)v.elementAt(0);
				String	title = "" + v0.size() + "  NOT controlled servers";
				String[]	columns = {
								"Server Name", "Last exported date"
							};
				tableDialog = new app_util.PopupTable(this, title, columns, v);
			}
			catch(DevFailed e)
			{
