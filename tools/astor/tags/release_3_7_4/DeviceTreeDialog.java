...
public class DeviceTreeDialog extends javax.swing.JDialog {
	 ...
	 */
	//============================================================
	app_util.PopupText	notCtrlServersDialog = null;
	private void ctrlServersButtonActionPerformed (java.awt.event.ActionEvent evt) {

		if (notCtrlServersDialog==null)
		{
			String[]	servers = tree.getNotCtrlServers();
			notCtrlServersDialog = new app_util.PopupText(this, false);
			String	title = "" + servers.length + "  NOT controlled servers";
			notCtrlServersDialog.show(title, servers, 300, 700);
		}
		else
			notCtrlServersDialog.show();
	}
	//============================================================
	/**
	 *	Closes the dialog
