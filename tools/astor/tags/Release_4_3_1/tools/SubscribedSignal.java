...
public class SubscribedSignal implements TangoConst
{
	...
	{
		//	Compeare all values and get delta maxi
		double	dv_max   = 0.0;
		double	relative = 0.0;
	...
	static String getStrDate(long ms)
	{
		...
		String	date = (String)v.elementAt(3) + "  " +
						(String)v.elementAt(2) + " " + (String)v.elementAt(1);
		return date;
	}
	//=====================================================================
	//=====================================================================
	...
	private void setValue(DeviceAttribute attr) throws DevFailed
	{
		value = "";
		String	format = null;
		if (attinfo!=null && attinfo.format.equals("Not specified")==false)
	...
	class EventHisto
	{
        ...
        //=========================================================================
        EventHisto(long time, Exception except)
        {
            this.time    = time;
            this.except  = except;
            this.values  = null;
