...
public class Astor extends JFrame implements AstorDefs
{
	 ...
	 */
	private static String revNumber = "Revision 3.8.0  -  Wed Feb 16 14:38:05 CET 2005";
...
//===========================================================
	...
	private void helpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_helpActionPerformed
		...
		if (item.equals(aboutBtn.getText()))
		{
			...
			app_util.PopupMessage.showImage(this, message, "/admin/astor/img/tango_icon.jpg");
		}
		else
		if (item.equals(starterEventsItem.getText()))
		{
			...
			if (hostnames==null)
				...
				new app_util.PopupText(this, true).show(title, hostnames, 250, 400);
		}
		else
