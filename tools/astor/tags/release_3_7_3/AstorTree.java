...
public class AstorTree extends JTree  implements AstorDefs
{
	...
	public AstorTree(Astor parent, boolean polling) throws DevFailed
	{
		...
		monitor = new Monitor(parent, "Subscribing events",	hosts[0].getName());
		hosts_using_evt = new Vector();
		for (int i=0, cnt=0 ; i<hosts.length ; i++)
		{
	...
	void updateMonitor()
	{
		...
		//System.out.println(message + ": " + ratio);
	...
	private void createNodes(DefaultMutableTreeNode root)
	{
		DefaultMutableTreeNode[] collection =
					new DefaultMutableTreeNode[collec_names.length];
...
//======================================================
	...
	void displayDbaseInfo()
	{
		...
		else
		{
			...
			//jive.setVisible(false); //	to be sure to be in good workspace.
