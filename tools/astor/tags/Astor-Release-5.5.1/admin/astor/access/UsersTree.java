...
//
// $Log$
// Revision 1.5  2011/01/04 14:34:18  pascal_verdier
// Password added for access control dialog.
//
// Revision 1.4  2009/02/18 09:51:46  pascal_verdier
...
//===============================================================
    ...
    //===============================================================
    @SuppressWarnings({"UnusedDeclaration"})
    private Vector<String> getUserList()
    {
...
private class TangoRenderer extends DefaultTreeCellRenderer
	...
	//===============================================================
	class CopiedDevices extends Vector<AccessDevice>
	{
	...
	//===============================================================
	class CopiedAddresses extends Vector<AccessAddress>
	{
