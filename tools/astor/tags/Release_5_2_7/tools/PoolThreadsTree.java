...
public class  PoolThreadsTree  extends JTree implements TangoConst
{
		...
		if (node!=null)
		{
			...
			if (obj instanceof PollThread)
			{
				...
				if (node.getChildCount()==0)
				{
					...
					app_util.PopupError.show(parent, "Cannot remove a not empty thread !");
			}
		}
	}
	//===============================================================
	 ...
	 */
	//===============================================================
	private class PollThread extends Vector
	{
		String	name;
		int		num;
		//===========================================================
	 ...
	 */
	//===============================================================
	private class PoolThreadsInfo extends Vector // vector of threads
	{
		int	size = 1;
		//===========================================================
