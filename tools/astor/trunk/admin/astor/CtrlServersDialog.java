...
public class CtrlServersDialog extends javax.swing.JDialog {
    ...
    /*
      ...
      */
    //============================================================
    public void show(String title, ArrayList servnames, ArrayList<DbServInfo[]> serverInfoList) {
        ServersTree tree = new ServersTree(parent,
                "Controlled Servers", servnames, serverInfoList);
    ...
    class DisplayThread extends Thread {
        ...
        public DbServInfo[] getControledServers(String hostname) throws DevFailed {
            ...
            ArrayList<DbServInfo> servers = new ArrayList<DbServInfo>();
        ...
        public void run() {
            ...
            ArrayList<DbServInfo[]> serverInfoList = new ArrayList<DbServInfo[]>();
            ...
            show(title, servnames, serverInfoList);
        }
    }
}
